    ...
    <section id="home" className="min-h-screen flex items-center bg-gray-900">
      <div className="container mx-auto px-6 py-16 text-center">
        ...
        <div className="flex justify-center space-x-4 mb-10">
            ...
            <a href="https://www.linkedin.com/in/tahsim-akram03/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300"><Github size={28} /></a>
        </div>
    ...
    <div className="container mx-auto px-6 text-center">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-8">
        ...
        <div className="flex items-center text-lg">
          ...
          <a href="https://www.linkedin.com/in/tahsim-akram03/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300">
