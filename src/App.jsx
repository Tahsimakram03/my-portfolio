...
const HeroSection = () => {
  ...
  // Google Drive direct-download URL (file id you provided)
  const driveDownloadUrl = "https://drive.google.com/uc?export=download&id=14jq0jCk7dNcU_mwyZwYzjf6hxy5MNnLK";
    ...
    <section id="home" className="min-h-screen flex items-center bg-gray-900">
      <div className="container mx-auto px-6 py-16 text-center">
        ...
        <div className="flex justify-center items-center flex-wrap gap-4">
          <button onClick={() => scrollToSection('projects')} className="bg-cyan-500 text-white font-bold py-3 px-8 rounded-full hover:bg-cyan-600 transition-transform duration-300 transform hover:scale-105">
            View My Projects
          </button>

          {/* Updated: direct-download Google Drive link */}
          <a
          ...
          <button onClick={() => scrollToSection('contact')} className="bg-gray-700 text-white font-bold py-3 px-8 rounded-full hover:bg-gray-600 transition-transform duration-300 transform hover:scale-105">
            Connect with Me
          </button>
        </div>
      </div>
